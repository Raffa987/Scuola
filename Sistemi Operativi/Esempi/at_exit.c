...
/*Gli "\" servono per contiuare la linea*/
...
//Messaggi che stamperemo all'uscita
...
int main(int argc, char *argv[]) {
    ...
    // atexit potrebbe fallire quindi se la funzione ritorna un nuemro diverso da 0
    // fermiamo il programma e diamo errore
...
//Il comando atexit eseguirà alla chiusura tutto quello che gli è stato passato, metterà le chiamate in
//una pila, nel programma chiamiamo in ordine 2-1-1 ma verrà stampato 1-1-2
